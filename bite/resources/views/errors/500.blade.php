...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Server Error - {{ config('app.name', 'Bite') }}</title>
            ...
            <div class="w-full max-w-md fade-rise">
                ...
                <div class="surface-card px-6 py-7 shadow-[0_26px_42px_-30px_rgba(8,13,23,0.95)] sm:px-8 sm:py-9">
                    <div class="space-y-5 text-center">
                        <p class="section-headline">Error 500</p>
                        <h1 class="font-display text-3xl font-extrabold leading-none text-ink">Server Error</h1>
