<div class="space-y-6 fade-rise" wire:poll.10s>
    ...
    <section class="surface-card p-5 sm:p-7">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative">
                    ...
                    @if($showNotifications)
                        <div class="absolute right-0 top-full z-50 mt-2 w-80 rounded-xl border border-line bg-panel shadow-xl sm:w-96">
                                ...
                                @forelse($notifications as $notification)
                                    <div class="px-4 py-3 {{ $notification->read_at ? 'opacity-60' : '' }}">
                                        <div class="flex items-start justify-between gap-2">
                                            ...
                                            @if(!empty($notification->data['whatsapp_link']))
        ...
        <div class="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4 transition-opacity duration-300" wire:loading.class="opacity-60">
