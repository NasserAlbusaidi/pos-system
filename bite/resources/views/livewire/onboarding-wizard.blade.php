                ...
                <div class="p-8 sm:p-10 space-y-8">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div class="flex flex-wrap gap-2 justify-center">
                            <button
                                x-on:click="navigator.clipboard.writeText({{ Js::from($menuUrl) }}).then(() => { copied = true; setTimeout(() => copied = false, 2000) })"
                                class="btn-secondary"
                            >
                    ...
                    {{-- Navigation Links --}}
                    @error('menu')
                        <div class="rounded-lg border border-alert/30 bg-alert/10 px-4 py-3 text-sm font-semibold text-alert">
                            {{ $message }}
                        </div>
                    @enderror
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <button wire:click="completeOnboardingAndOpenPos" class="btn-secondary w-full justify-center py-3">
